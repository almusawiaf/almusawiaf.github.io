...
import { Mail, GraduationCap, BookOpen, ExternalLink, Calendar, MapPin } from "lucide-react";
    ...
    <section className="relative overflow-hidden bg-[#111112] border border-white/5 rounded-3xl p-6 md:p-12 shadow-sm mb-8">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-12">
        ...
        <div className={`flex-1 text-center ${isRTL ? "md:text-right" : "md:text-left"}`}>
          ...
          <h1 className="text-3xl md:text-5xl font-display font-bold tracking-tight text-white leading-[1.1]">
            {t.hero.name}
          </h1>
          
          <p className="text-base md:text-xl font-medium text-slate-300 mt-2 font-sans">
            {t.hero.title}
          </p>
          ...
          {/* Quick Details */}
          <div className={`flex flex-wrap justify-center ${isRTL ? "md:justify-start" : "md:justify-start"} gap-y-2 gap-x-6 mt-5 text-xs font-mono text-slate-400`}>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>{t.hero.educationBadge}</span>
            </div>
          </div>

          {/* Email Contacts */}
          <div className={`mt-5 flex flex-col sm:flex-row justify-center ${isRTL ? "md:justify-start" : "md:justify-start"} gap-3 sm:gap-6 text-sm text-slate-400 border-t border-white/5 pt-4`}>
            <a
          ...
          {/* Professional Links */}
          <div className={`mt-6 flex flex-wrap justify-center ${isRTL ? "md:justify-start" : "md:justify-start"} gap-2.5`}>
            <a
            ...
            >
              ...
              <span>{t.hero.researchGateBtn}</span>
              <ExternalLink className="w-3 h-3 opacity-60" />
            </a>
